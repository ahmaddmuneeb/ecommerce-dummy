        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div>
                    ...
                    <img class="m-4 p-4 w-50" src="{{ asset('images/p4.jpg') }}" alt="erorr-loading-image">
                </div>
            </div>
            <div class="col-md-6">
                <h1>720P 1MP HILOOK by HIKVISION System</h1>
                <h3 class="mt-4">
                    <b>Rs 10800</b>
                </h3>
                <p class="mt-4">
                    ...
                    HILOOK BY HIKVISION 4CH CCTV KIT WITH 1TB HARD DISK. 4 x 2MP (1080P)
                    BULLET HD-TVI CAMERA. 4 CHANNEL TRIBRID DVR. 1TB SURVEILLANCE HARD DISK INSIDE
