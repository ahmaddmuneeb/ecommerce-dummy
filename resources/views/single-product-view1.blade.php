        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div>
                    ...
                    <img class="m-4 p-4 w-50" src="{{ asset('images/p1.jpg') }}" alt="erorr-loading-image">
                </div>
            </div>
            <div class="col-md-6">
                <h1>720P AHD 1MP Alpha Vision Brand System</h1>
                <h3 class="mt-4">
                    <b>Rs 9000</b>
                </h3>
                <p class="mt-4">
                    ...
                    XVR:4CH 720p, Video: 4CH, Audio: 1,
                    HDMI, 1SATA - UP TO 4TB
                    Recording(real time):4*960H (20FPS/CH),
                    Playback (real time):4*960H*
                    4 - AHD 720P Outdoor Cameras with 3-Axis Brackets,15m Night Vision Cameras ,
                    4 - 15 meters Cable for flexible installation;
                    4 - way camera power adapters for efficient installation;
                    1 - Power supply for Camera 2A UL certified wide 3.0mm lens

                    ** System includes 3TB Hard disk (3 Months Recording) & Installation**

                    **Fitting Such as PVC pipes, plexo box, Lan cables all inclusive**
