        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div>
                    ...
                    <img class="m-4 p-4 w-50" src="{{ asset('images/p6.jpg') }}" alt="erorr-loading-image">
                </div>
            </div>
            <div class="col-md-6">
                <h1>1080P 2MP HIKVISION System</h1>
                <h3 class="mt-4">
                    <b>Rs 12800</b>
                </h3>
                <p class="mt-4">
                    ...
                    4CH – 4 CAM
                    HD1080P,2MP COMPLETE KIT Comprising of 1DVR DS-7104HQHI-K1 + 2 Bullet +
                    2 Dome + HDD 3TB + cables, adaptors and accessories
